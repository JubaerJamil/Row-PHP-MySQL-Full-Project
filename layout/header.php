<?php define('BASE_URL', 'http://localhost/newPortfolio/');?>
<!DOCTYPE html>
<html lang="en">
<head>
  <!-- required meta -->
  ...
  <!-- #title -->
  <title>Jubaer Jamil - Web Developer</title>
  <!-- #favicon -->
  <link rel="shortcut icon" href="assets/images/faviconjjjjj_.png" type="image/x-icon" />
