                                    ...
                                    <form action="../../controller/product.php" method="POST" enctype="multipart/form-data">
                                        <div class="d-flex">
                                            ...
                                            <div class="col-lg-6 ms-2">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="product_name" value="<?php echo $item['product_name'];?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="product_price" value="<?php echo $item['price'];?>"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="link" value="<?php echo $item['preview_link'];?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="short_dis" id="" value="<?php echo $item['product_short_info'];?>" required>
                                            </div>
                                        </div>
