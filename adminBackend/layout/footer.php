            ...
            <div class="row">
                <div class="col-md-6 text-center text-md-start">
                    <script>document.write(new Date().getFullYear())</script> © All Rights Reserved - By <span
                        class="fw-bold text-decoration-underline text-uppercase text-reset fs-12">Jubaer Jamil</span>
                </div>
            </div>
        </div>
    </footer>
...
<script src="<?php echo BASE_URL; ?>assets/js/pages/dashboard-sales.js"></script>
<!-- dataTable -->
