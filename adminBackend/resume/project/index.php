...
<?php
$query = "SELECT * FROM resume_projects ORDER BY id DESC";
                ...
                <div class="card">
                    <div class="card-header border-bottom border-light">
                        <div class="d-flex flex-wrap gap-2 justify-content-end">
                            <div>
                                <a href="create.php" class="btn btn-primary"><i class="ti ti-plus me-1"></i>Add Project</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <?php foreach ($allList as $index => $item): ?>
                                    <tr>
                                        ...
                                        <td><textarea disabled cols="100"  rows="3"><?php echo $item['project_details']; ?></textarea></td>
                                        <td><?php echo $item['project_link']; ?></td>
                                        <td>
