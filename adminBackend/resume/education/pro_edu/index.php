...
<?php
$query = "SELECT * FROM  pro_education ORDER BY id DESC";
    ...
    <div class="page-container">
        ...
        <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold mb-0">Professional Education List</h4>
            </div>
                            ...
                            <tbody>
                                <?php foreach ($allList as $index => $item): ?>
                                    <tr>
                                        ...
                                        <td><?php echo $item['institute_name']; ?></td>
                                        <td><?php echo $item['course_duration']; ?></td>
                                        <td><?php echo $item['mentor']; ?></td>
                                        <td>
