                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <?php
                                $id = $_GET['id'];
                                $editQuery = "SELECT * FROM interests WHERE id= $id";
                            ...
                            <form action="../../controller/interest.php" method="POST">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="productName" class="form-label">Interest Name</label>
                                        <input type="text" class="form-control" name="interest_name" id="" value="<?php echo $item['interest_name'];?>" required>
                                    </div>
                                </div>
