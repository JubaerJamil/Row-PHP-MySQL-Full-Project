...
<?php
$query = "SELECT * FROM  work_experience ORDER BY id DESC";
    ...
    <div class="page-container">
        ...
        <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold mb-0">Work Experience List</h4>
            </div>
                            ...
                            <tbody>
                                <?php foreach ($allList as $index => $item): ?>
                                    <tr>
                                        ...
                                        ?>
                                        <td><textarea disabled class="form-control" cols="55"
                                                rows="3"><?php echo $item['responsibility']; ?></textarea></td>
                                        <td>
                                            <span
                                            ...
                                            <div class="hstack gap-1 justify-content-end">
                                                ...
                                                <form action="../../controller/work_exprience.php" method="POST">
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        name="deleteBtn"><i class="fa-solid fa-trash-can fs-4"></i></button>
                                                </form>
                                            </div>
                                        </td>
                                    </tr>
