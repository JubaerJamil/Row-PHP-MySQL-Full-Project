...
<?php
$query = "SELECT * FROM language_skills ORDER BY id DESC";
    ...
    <div class="page-container">
        ...
        <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold mb-0">Languages Skills List</h4>
            </div>
                ...
                <div class="card">
                    <div class="card-header border-bottom border-light">
                        <div class="d-flex flex-wrap gap-2 justify-content-end">
                            <div>
                                <a href="create.php" class="btn btn-primary"><i class="ti ti-plus me-1"></i>Add Languages</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <?php foreach ($allList as $index => $item): ?>
                                    <tr>
                                        ...
                                        <td><?php echo $item['languages_name']; ?></td>
                                        <td>
