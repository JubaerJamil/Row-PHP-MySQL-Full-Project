                        ...
                        ?>
                                <div class="d-flex">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="productName" class="form-label">Project Category</label>
                                                <select disabled class="form-select my-1 my-md-0 me-sm-3">
                                    ...
                                    <div class="col-lg-6 ms-2">
                                        <div class="mb-3">
                                            ...
                                            <input readonly type="text" class="form-control" name="service_title" value="<?php echo $item['service_title'];?>" required >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input readonly type="text" class="form-control" name="service_name" value="<?php echo $item['service_name'];?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 ms-2">
                                        <div class="mb-3">
                                            ...
                                            <input readonly type="text" class="form-control" name="technology_name" value="<?php echo $item['Technologies'];?>" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input readonly type="text" class="form-control" name="client_name" value="<?php echo $item['client_name'];?>" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 ms-2">
                                        <div class="mb-3">
                                            ...
                                            <input readonly type="text" class="form-control" name="preview_link" value="<?php echo $item['view_link'];?>" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea disabled class="form-control" name="content" id="myEditor" rows="12"
