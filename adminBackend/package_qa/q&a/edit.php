                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <?php
                                $id = $_GET['id'];
                                $editQuery = "SELECT * FROM q_and_ans WHERE id= $id";
                            ...
                            <form action="../../controller/Q&A.php" method="POST">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="productName" class="form-label">Question</label>
                                        <input type="text" class="form-control" name="question" id="" value="<?php echo $item['question'];?>" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="description" class="form-label">Answer</label>
                                        <textarea class="form-control" name="answer" rows="15"><?php echo $item['answer'];?></textarea>
                                    </div>
                                </div>
