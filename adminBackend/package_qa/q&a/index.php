...
<?php
$query = "SELECT * FROM q_and_ans ORDER BY id DESC";
    ...
    <div class="page-container">
        ...
        <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold mb-0">Question & Answer List</h4>
            </div>
                ...
                <div class="card">
                    <div class="card-header border-bottom border-light">
                        <div class="d-flex flex-wrap gap-2 justify-content-end">
                            <div>
                                <a href="create.php" class="btn btn-primary"><i class="ti ti-plus me-1"></i>Add New Q & A</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <?php foreach ($allList as $index => $item): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <textarea class="form-control" cols="25" rows="3"><?php echo $item['question']; ?></textarea>
                                        </td>
                                        <td>
                                            <textarea class="form-control" cols="45" rows="3"><?php echo $item['answer']; ?></textarea>
                                        </td>
                                        <td>
                                        ...
                                        <td class="pe-3">
                                            <div class="hstack gap-1 justify-content-end">
                                                ...
                                                <form action="../../controller/Q&A.php" method="POST">
