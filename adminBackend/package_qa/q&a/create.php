            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header border-bottom border-dashed">
                        <h4 class="card-title">Add Question and Answer</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <form action="../../controller/Q&A.php" method="POST">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="question" id="" placeholder=""
                                            required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="answer" id="" rows="7"></textarea>
                                    </div>
                                </div>
