                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="p_name" id="" value="<?php echo $item['p_name'];?>" required >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 ms-2">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="p_duration" id="" value="<?php echo $item['p_duration'];?>" required >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="p_amount" id="" value="<?php echo $item['p_price'];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 ms-1 me-1 <?php echo $item['have_dis'] == 0 ? 'd-none' : 'd-block';?>"  id="dis_amount">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="discount_amount" name="dis_amount" value="<?php echo $item['p_dis_amount'];?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="p_c_1" id="" value="<?php echo $item['item_1'];?>">
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-lg-6 ms-2">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="p_c_2" id="" value="<?php echo $item['item_2'];?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="p_c_3" id="" value="<?php echo $item['item_3'];?>">
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-lg-6 ms-2">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="p_c_4" id="" value="<?php echo $item['item_4'];?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="p_c_5" id="" value="<?php echo $item['item_5'];?>">
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-lg-6 ms-2">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="p_c_6" id="" value="<?php echo $item['item_6'];?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="p_c_7" id="" value="<?php echo $item['item_7'];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="status" id="active" value="1" <?php echo $item['status'] == 1 ? 'checked' : '';?>>
                                                <label class="form-check-label" for="active">Active</label>
                                            </div>
                                            <div class="form-check ms-2">
                                                <input class="form-check-input" type="radio" name="status" id="inactive" value="0" <?php echo $item['status'] == 0 ? 'checked' : '';?>>
